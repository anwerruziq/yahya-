...
const SidebarPage = () => {
  ...
  const allProjects = {
    "صور 3D": [
      {
        ...
        image: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-3d-vid-y/3d%20show_low.mp4"
      },
      {
        title: "تصميم 3D متقدم - مشروع 2",
        image: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-3d-vid-y/677.mp4"
      },
      {
        title: "تصميم ثلاثي الأبعاد - مشروع 3",
        image: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-3d-vid-y/cans.mp4"
      },
      {
        title: "مشروع 3D عالي الجودة - مشروع 4",
        image: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-3d-vid-y/student.mp4"
      },
      {
    ...
    "فيديوهات AI": [
      {
        title: "فيديو AI - مشروع كوبيكو 4K",
        video: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-videos-x/2car.mp4"
      },
      {
        title: "فيديو AI - تصميم شاي الشاعر",
        video: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-videos-x/3d%20ad%2023.mp4"
      },
      {
        title: "فيديو AI - مشروع مياه عدن",
        video: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-videos-x/3d678.mp4"
      },
      {
        title: "فيديو AI - تصميم مياه صنعاء",
        video: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-videos-x/new4.mp4"
      },
      {
        title: "فيديو AI - مشروع إبداعي",
        video: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-videos-x/oyu.mp4"
      },
      {
        title: "فيديو AI - تصميم احترافي",
        video: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-videos-x/2car.mp4"
      },
      {
        title: "فيديو AI - مشروع عالي الجودة",
        video: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-videos-x/3d%20ad%2023.mp4"
      },
      {
        title: "فيديو AI - تصميم متطور",
        video: "https://vzezgikywxmxmntbxczg.supabase.co/storage/v1/object/public/yahey/main-videos-x/3d678.mp4"
      }
    ]
  }
      ...
      <div className="sticky top-0 bg-dark-bg/95 backdrop-blur-sm border-b border-accent-blue/20 p-6 z-10">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl md:text-3xl font-bold text-accent-blue">
            {category || 'جميع الأعمال'} - جميع الأعمال
          </h2>
          <div className="flex items-center gap-4">
            <button
              onClick={() => window.location.href = '/'}
              className="flex items-center gap-2 px-4 py-2 text-accent-blue hover:text-white hover:bg-accent-blue rounded-full transition-all duration-300"
            >
            ...
            >
              <div className="relative overflow-hidden rounded-xl bg-gray-800">
                {project.video ? (
                       ...
                       preload="none"
                       autoPlay={false}
                    poster={`data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 192'%3E%3Crect width='400' height='192' fill='%23374151'/%3E%3C/svg%3E`}
                                         onMouseEnter={(e) => {
